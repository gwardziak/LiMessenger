...
// export const Login = () => {
//   const rootStore = useRootStore();
//   const [{ data, error, fetching }, reExecute] = useMeQuery({ pause: true });
//   const [loginCredential, setLoginCredential] = useState<string>("");
//   const [password, setPassword] = useState<string>("");
...
//       console.log(response.error);
//     } else {
//       console.log(response, "Mam ciastko");
//       console.log("autoryzuj");
//       rootStore.authStore.setIsAuth(true);
//       reExecute();
//       // await rootStore.authStore.authenticate();
//       console.log(rootStore.authStore.isAuthenticated, "isAuthFromLogin");
//       console.log(data);
//       history.replace("/");
//     }
//   };

...
//       //   scrollbarRef.current.scrollToBottom();
//       // }
//       const scrollHeight = scrollbarRef.current
//         ? scrollbarRef.current.scrollHeight
//         : 5000;
//       console.log(scrollbarRef.current?.scrollHeight);
//       scrollbarRef.current?.scrollTo(0, scrollHeight + 34);
//       console.log(scrollbarRef.current, "aktyalny ref");
//       // console.log(scrollbarRef!.current!.scrollToBottom());
//       setIsScrolled(true);
//     }
...
//         autoHide
//         noScrollX
//         onClick={(e: any) => scrollbarRef.current?.scrollToBottom()}
//       >
//         <Container>
//           <MessageDate>Dziś</MessageDate>
//           {rootStore.chatStore.roomMessages.map((messages) => {

...
import { useFirstMessagesQuery } from "./../generated/graphql";
import { SearchBar } from "./SearchBar";

export const FriendList = () => {
  const isBg = useMatchesMediaQuery([mediaQuery.bg]);
  const [{ fetching, data, error }] = useFirstMessagesQuery();
  ...
  return (
    <MyScrollbar autoHide noScrollX>
      <Container>
        {isBg && <SearchBar />}
        <List>
          {data.firstMessages.map((message) => (
            <Item>
